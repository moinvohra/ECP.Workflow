...
BEGIN	
	...
	select tenantid,applicationid from tmptenantapplication;
	   ...
	   insert into workflow.workflowdefinition (tenantid,applicationid,workflowname,workflowcode,sourceworkflowid,
	   definitionjson,	previewjson,status,	startdate,enddate,createddate,modifieddate,createdby,modifiedby)
	  select
	  _tenantid as tenantid,	applicationid,	workflowname,	workflowcode,sourceworkflowid,
	  definitionjson,	previewjson,status,	startdate,enddate,createddate,modifieddate,createdby,modifiedby
