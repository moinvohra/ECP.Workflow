    ...
    public static class QueryableExtensions
    {
        ...
        private static Filter PreliminaryWork(Type type, Filter filter)
        {
            ...
            if (currentPropertyType == typeof(DateTime) && DateTime.TryParse(filter.Value.ToString(), out DateTime dateTime))
            {
                ...
                if (filter.Operator == "eq")
                {
                    ...
                    newFilter.Filters = new List<Filter>
                    {
                        ...
                        new Filter
                        {
                            ...
                            Value = new DateTime(dateTime.Year, dateTime.Month, dateTime.Day, 0, 0, 0,DateTimeKind.Utc),
                            Operator = "gte"
                        },
                        ...
                        new Filter
                        {
                            Field = filter.Field,
                            Filters = filter.Filters,
                            Value = new DateTime(dateTime.Year, dateTime.Month, dateTime.Day, 23, 59, 59,DateTimeKind.Utc),
                            Operator = "lte"
                        }
                    };
                ...
                filter.Value = new DateTime(dateTime.Year, dateTime.Month, dateTime.Day, dateTime.Hour, dateTime.Minute, dateTime.Second, dateTime.Millisecond,DateTimeKind.Utc);
            }
