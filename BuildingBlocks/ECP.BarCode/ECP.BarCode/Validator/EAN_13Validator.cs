...
{
    class EAN_13Validator : BarCodeValidatorBase
    {
        const int REQUIRED_LEGNTH = 12;
        string INVALID_LENGTH_MESSAGE = "BarCodeGenerater needs 12 number of input characters ";
        ...
        public override bool Validate(string value)
        {
            ...
            {
                var EAN_13Match = Regex.Match(value, RegularExpressionConstant.EAN_13Regex);

                if (EAN_13Match.Success)
                {
                    return true;
